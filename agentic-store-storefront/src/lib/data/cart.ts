...
export async function retrieveCart(cartId?: string, fields?: string) {
  ...
  fields ??=
    "*items, *region, *items.product, *items.variant, *items.thumbnail, *items.metadata, +items.total, *promotions, +shipping_methods.name, +discount_total, *items.adjustments, *shipping_methods.adjustments"
